...
async function runTests() {
    ...
    try {
        ...
        // La ruta devuelve HTML, no JSON. Verificamos que sea exitosa.
        console.log('Acceso a /profile (JWT):', profileJwtRes.ok ? 'OK' : 'FALLÓ', `Status: ${profileJwtRes.status}`);
        ...
        console.log('Acceso a /profile (Cookie):', profileCookieRes.ok ? 'OK' : 'FALLÓ', `Status: ${profileCookieRes.status}`);
